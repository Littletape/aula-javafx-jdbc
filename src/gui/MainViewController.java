...
public class MainViewController implements Initializable {
	...
	private synchronized <T> void loadView(String absoluteName, Consumer<T> initializeAction) {
		// synchronized, garante processamento não interronpido durante o multi thread
		// Consumer para carregar uma expressão lambda como um parametro
		// lembrando que T é um tipo generico
		...
		try {
			...
			// executa a expressão lambda que foi declarada como parametro
